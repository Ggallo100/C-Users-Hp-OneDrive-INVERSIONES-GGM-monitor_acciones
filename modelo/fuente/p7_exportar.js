...
async function exportarExcel() {
  ...
  const r7 = [
    ...
    ['  REGULAR      se matriculó también el semestre inmediato anterior y cambió de ciclo:'],
    ['               continúa sin interrupción.'],
    ['  RECUPERADO   se matriculó también el semestre inmediato anterior, pero vuelve al MISMO'],
    ['               ciclo: perdió el que cursaba —figura como desertor de ese ciclo— y lo'],
    ['               retoma al semestre siguiente.'],
    ['  REINICIADO   interrumpió uno o más semestres y volvió a matricularse.'],
    ['La condición no se declara en ningún sitio ni necesita matriz de transición: la determinan'],
    ['el rezago y el salto de ciclo del propio flujo. Por eso el desglose de las tablas es'],
    ['exacto y suma siempre el total, sin parámetros añadidos.'],
    ['Es el factor de mayor magnitud del modelo, y separa dos riesgos que no se parecen.'],
    ['El REINICIADO es un problema de retención: continúa el 59,0 % de las veces frente al'],
    ['86,0 % de un regular, y la brecha sigue abierta al final del plan (73,4 % contra 94,5 %'],
    ['en el ciclo 9). El RECUPERADO pierde mucha menos matrícula —continúa el 70,9 %— pero'],
    ['pierde tiempo: sólo el 57,4 % avanza de ciclo, el 20,9 % repite otra vez y su avance'],
    ['medio es de 0,872 ciclos por semestre frente a 0,896. Se acumula en los ciclos bajos.'],
