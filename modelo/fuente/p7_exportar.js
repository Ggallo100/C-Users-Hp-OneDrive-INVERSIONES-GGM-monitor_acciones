...
async function exportarExcel() {
  ...
  const r7 = [
    ...
    ['El REINICIADO es un problema de retención: continúa el 58,2 % de las veces frente al'],
    ['86,0 % de un regular, y la brecha sigue abierta al final del plan (72,7 % contra 94,4 %'],
    ['en el ciclo 9). El RECUPERADO pierde mucha menos matrícula —continúa el 70,7 %— pero'],
    ['tiempo: sólo el 57,4 % avanza de ciclo, el 20,9 % repite otra vez y su avance medio es de'],
    ['0,871 ciclos por semestre frente a 0,896. Se acumula en los ciclos bajos.'],
